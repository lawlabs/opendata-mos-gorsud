...
Но фактически обнволений в базе данных нет с 24.04.2025 года - несмотря на то, что дата обновления файлов с базой и даты в описании обновляются каждую неделю, в самой базы данные только по 24.04.2025 года.

Но с мая 2026 года данные в базе опять стали обновляться. Но 28.05.2026 года:
...
Внимание! База данных занимает около 12 гигабайт, необходимо иметь достаточно места на диске для загрузки, импорта данных и работы программы.  Процесс загрузки файла JSON в архиве zip, извлечения его из архива, конвертации в базу данных занимает от 1 до 1,5 часов.
